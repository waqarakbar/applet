...
<?php $sn = 1; ?>
    ...
    <div class="row mt-5">
        ...
        <label for="" class="form-label">
            ...
            <button id="copyButton<?php echo $sn; ?>" class="btn btn-success btn-sm">Copy</button>&nbsp;&nbsp;
                <span id="msg<?php echo $sn; ?>" style="color: green"></span>
        </label>
        <br>
        <textarea name="" class="gt_data form-control" id="textarea<?php echo $sn; ?>" cols="100" rows="1"><?php echo $client_id; ?></textarea>
        </div>
    </div>
    <?php $sn++; ?>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            ...
            <br>
            <textarea name="" class="gt_data form-control" id="textarea<?php echo $sn; ?>" cols="100" rows="1"><?php echo $client_secret; ?></textarea>
        </div>
    </div>
    <?php $sn++; ?>
    ...
    <?php foreach($response_data as $gtk => $gtd): ?>
        ...
        <div class="row mt-4">
            ...
            <br>
            <textarea name="" class="gt_data form-control" id="textarea<?php echo $sn; ?>" cols="100" rows="3"><?php echo $gtd; ?></textarea>
            </div>
        </div>
        <?php $sn++; ?>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <a href="./get_consent.php" class="btn btn-danger">Generate New Token</a>
        </div>
    </div>
